...
var FolderPropertiesService = (function () {
    ...
    FolderPropertiesService.prototype.toProperty = function (element) {
        var property = new property_1.Property(element.instanceId, element.properties.Description, element.properties);
        ...
        for (var name_1 in property.getCustomProps()) {
            if (property.getCustomProps().hasOwnProperty(name_1)) {
                property.addCustomProp(name_1, property.getCustomProps()[name_1], property_1.PropertyType.String);
            }
        }
        return property;
    };
