...
var FolderPropertiesComponent = (function () {
    function FolderPropertiesComponent(_route, _router, _dataService) {
        this._route = _route;
    ...
    FolderPropertiesComponent.prototype.onBack = function () {
        this._router.navigate(['/pwTreeNav']);
    };
...
FolderPropertiesComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        selector: 'selector',
        templateUrl: 'folderProperties.component.html'
    }),
    __metadata("design:paramtypes", [router_1.ActivatedRoute, router_1.Router, typeof (_a = typeof folderProperties_service_1.FolderPropertiesService !== "undefined" && folderProperties_service_1.FolderPropertiesService) === "function" && _a || Object])
